...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    div(style = "float: left; width: 48%", # this number can be any percentage you need
        sliderInput(
          "Se",
          "Sensitivity or True Positive Rate: Percentage of true patients with test scores above the intersection:",
          min = 0.5,
          max = 1,
          value = .85,
          width='100%'
    ...
    div(style = "float: right; width: 48%", # this number can be any percentage you need
        sliderInput(
          "Sp",
          "Specificity or True Negative Rate: Percentage of true non-patients with test scores below the intersection:",
          min = 0.5,
          max = 1,
          value = .85,
          width = '100%'
    ...
    textOutput("overlap"),
    p(
      "The point of intersection is equal to the optimal ", 
      span("dichotomous", style = "color:blue"), " threshold 
      ...
      the quality of the test can be adapted."
    ),
    checkboxInput(
      "combineSliders",
      "Combine the Specificity slider with the Sensitivity slider ",
      TRUE
    ),
    ...
    tabsetPanel(
      tabPanel(
        ...
        p(
          ...
          Sensitivity and Specificity, allowing to compare the trichotomized results with the
          optimal dichotomous results. Tests are simulated with higher
            test scores indicating the presence of the disease."
          ),
        p(
       ...
       p(
       'When a clinical population is involved,
          the prevalence of a disease (for instance Mild Cognitive
          Impairment or MCI), may differ strongly from hospital to
          hospital and may differ over time. A clinical population is for
          instance the patients who are referred to a specific department of
          hospitals (for instance, a Neurology Department). Clearly, the
          prevalence of the disease in such a
       ...
       h4('Other Tabs'),
        ...
        tags$ul(
          ...
          tags$li(
            "Output Tables. Description of the two output tables."
          ),
      ...
      tabPanel(
        ...
        p(
          ...
          dichotomous Sensitivity and Specificity, allowing to compare the
          trichotomized results with the optimal dichotomous results. There 
          are two ways to create distributions with unequal
          variance: by choosing different values for Se and Sp, or by
        ...
        tags$ul(
          tags$li(
            "1. Choose the Predictive Values Output Table and keep the 
            Sensitivity and Specificity sliders combined. Move the sliders to 
            values lower than .85. Observe that the
            ...
            overlap and is therefore of low quality. When the sliders hit .63,
            the size of the Grey Zone is 100% and covers all scores. The Grey
            Zone method is not to be used for weak tests."
          ),
          tags$li(
            '2. Make the test stronger by setting Se and Sp to .9. With
            the criterion of .9 for the positive post probability and .1 for the 
            negative post probability, the left
          ...
          tags$li(
            "3. Make the test even stronger. When moving the Se slider to values above .9, the two
            borders are switched (black to the right and red to the left) and
            the Grey Zone has a negative size. These stronger tests have a Grey zone with a negative
            size and a
            better optimal dichotomous result'), tags$em('reduces'), ('the 
            predictive values for the upper and lower non-grey interval to the 
            criterion, which is undesirable. Clearly, such a
          ...
          tags$li(
            ...
            distributions with unequal variance. Set the Sensitivity
            to .85 and the Specificity to .75. The variance of
            ...
            the highest scores are more indicative of absence than presence of the
            ...
            restrictive) to obtain a smaller Grey Zone. Choosing a lower value 
            for the negative post-test criterion makes the grey zone larger 
            (more variance, more restrictive).
            Change for instance the value for the positive post-test criterion
            to .85. In that case, the post-test predictive value of the Grey
          ...
          tags$li(
          "5. Move the Specificity slider to .53. Now, the positive post-test
          ...
          tags$li(
            "6. Move the Specificity slider back to .85 and the post-test probabilities
          ...
          tags$li(
            "7. Now, set the Sensitivity to .66. With a
            pretest-probability of 39 and a Specificity of .85, two distributions with
      ...
      tabPanel(
        ...
        p(
          ...
          symptoms that have led to a medical department, and who may have or may not have the disease for which
          will be tested. Often, such a clinical population is not well
          described and knowledge of the true presence of the disease n this population.
          The patients are pre-selected, based on their symptoms. Therefore, a 
          pre-test probability of .5 may
          be chosen, assuming an equal chance that the patient is chosen from either of
          ...
          the illness or not.'),
        h4('Setting dichotomous Sensitivity and Specificity'),
        p(
          ...
          True Positives when the optimal dichotomous cut-point would be
          used as the decision threshold. The lower slider sets the percentage 
          of patients which are
          known to not have the disease and who have test scores below the
          point of intersection, indicating the amount of True Negatives for
          ...
          method. The False negative rate (FNR) equals 1 - Sensitivity and the 
          False Positive Rate (FPR) equals 1 -
          Specificity. The two values determine the overlap between the
          distributions. The pre-test probability sets the expectation of the 
          disease before testing, or the relative weight of the two populations.',
          p(
          ...
          bi-normal tests of varying strengths can be simulated. "
          ),
        ),
        h4('Combining the Se slider with the Sp slider'),
        p(
      ...
      tabPanel("Output Tables",
       ...
       p(
         ...
         scores. The post-test predictive probabilities are equal to
         the Positive Predictive Values (PPV) when the pre-test probability
         is equal to the prevalence of the disease in the sample. The Standardized Positive
         ...
         test scores is almost always equal to the set criterion for the negative
         ...
         and upper non-Grey Zone are equal to the pre-set criteria for
       ...
       p(
         'The first row shows the predictive values for the ', 
         span("dichotomized", style = "color:blue"), '
       ...
       p("N.B. The post-test probability is always equal to the positive 
         post-test probability. For each interval of test scores, the negative post-test 
         probability is equal to 1 - positive post-test probability."),
      p(
      ...
      p(
        'The first row provides the Se and Sp for the dichotomized results.
         ...
         of FNR + FPR. The dichotomization uses all scores. As Se and Sp are set 
         they are not dependent on the pre-test probability.'
      ),
      p(
        'The second row provides the Sensitivity and Specificity solely for
         ...
         Sensitive nor Specific when using these Grey zone scores. These Se and Sp are
      ...
      p(
        'The third row provides the Sensitivity and Specificity solely for
         ...
         Specific when solely using these scores for a positive or negative 
         decision. The Se and Sp of the grey zone are dependent on
         the pre-test probability, as the  Grey zone may contain a larger part
         from one distribution and a smaller part of the other.(See also Background Information).'
      )
      ), # tabPanel
